...
def population():
    """
    encapsulates the capability to initialize population of chromosomes.
...
def _link_distance(link):
    """
    for calculating distance b/w links
...
def _link_prob(link_fit):
    """
    calculates the probability of links.
...
def _create_pop(link_cum_prob):
    """
    creating chromosome population based on connection
    b/w links.
...
def _both_equ(element_1, element_2):
    """
    finding if both elements are equal or not.
    ...
    -------
    [Bool]
        [True or False based on whether both elements were equal or not]
    """
...
def calculate_distance(pt_1, pt_2):
    """
    encapsulates the capability of calculating distance b/w two points.
