...
def dna(chr_pop_fitness, ranked_population, chr_best_fitness_index, last_pop):
    """
    functionality related to dna like crossover
    and mutation.
...
def _do_mutation(pop):
    """
    for handling mutation in population of chromosomes.
...
def _do_crossover(ranked_pop, chr_best_fit_indx, pop):
    """
    for handling crossover in population of chromosomes.
