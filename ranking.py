...
def ranking(chr_pop_fitness, pop):
    """
    encapsulates the capability of generate ranking of chromosome
    population based on roulette wheel selection method.
...
def _generate_mating_pool(chr_rank, pop):
    """
    for generating mating pool which will undergo
...
def _ranking_based_on_roulet_wheel_selection(chr_cum_prob):
    ...
    -------
    [numpy.ndarray]
        [ranks of chromosomes based on roulette wheel selection method]
    """
