...
def fitness(chr_pop):
    """
    for calculating fitness of chromosomes
...
def chr_best_fit_ind(chr_fit):
    """
    for finding best fitness chromosome indices.
...
def chr_fit(chr_fit_based_dist, chr_fit_based_conn):
    """
    for calculating fitness of chromosome population
...
def chr_conn(chr_pop):
    """
    for finding number of connections b/w path points of
...
def chr_fit_based_dist(chr_pts_consec_dist):
    """
    for calculating chromosome fitness based on total
...
def chr_pts_consecutive_dist(pop):
    """
    for calculating total distance of individual
